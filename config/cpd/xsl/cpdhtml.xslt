...
<body>
    ...
    <table border="1" class="summary" cellpadding="2">
      ...
      <tr>
        <td class="SummaryNumber"><xsl:value-of select="count(//duplication[@lines>10])"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>10]/@lines)"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>10]/@tokens)"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>10]/@tokens) * 4"/></td>
      </tr>
    </table>
    <p/>
    ...
    <xsl:for-each select="//duplication[@lines>10]">
